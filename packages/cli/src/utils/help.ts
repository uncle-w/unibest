...
export function printHelp(): void {
  ...
  console.log('  --lime-echart          添加 lime-echart 图表库（ECharts全端兼容）')
  console.log('  --ucharts              添加 ucharts 图表库（秋云高性能跨平台）')
  console.log('                         支持多选: --lime-echart --ucharts')
  console.log('')
  console.log(color.blue('添加Feature选项:'))
  console.log('  <feature>              要添加的 Feature (i18n, login, lime-echart, ucharts)')
  ...
  console.log('  pnpm create unibest my-project --lime-echart --ucharts  # 添加图表库')
  console.log('')
  ...
  console.log('  pnpm create unibest add lime-echart ucharts  # 添加图表库')
  console.log('')
}
